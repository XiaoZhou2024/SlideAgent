...
def process_task_wrapper(task: ReportTask, sql_generator: SqlGenerator) -> bool:
    """
...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        # 提交所有任务到线程池
        future_to_task = {executor.submit(process_task_wrapper, task, sql_generator): task for task in all_tasks}
